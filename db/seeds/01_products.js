  ...
  await knex("products").insert([
    {
      ...
      product_type: knex.raw("?::TEXT[]", [
        ["Cold & Flu", "Inflammation & Joint Pain", "Overall Immunity"],
      ]),
      product_title: "Vitamin C",
      img: "/assets/products/vitamin_c.jpg",
      product_description:
    ...
    },
    {
      id: 2,
      product_type: knex.raw("?::TEXT[]", [
        ["Inflammation & Joint Pain", "Stress & Anxiety", "Fibromyalgia"],
      ]),
      product_title: "CBD Salve",
      img: "/assets/products/cbd_salve.jpg",
      product_description:
    ...
    },
    {
      id: 3,
      product_type: knex.raw("?::TEXT[]", [
        ["Stress & Anxiety", "Fibromyalgia", "Muscle Recovery"],
      ]),
      product_title: "Epsom Salts",
      img: "/assets/products/epsom_salts.jpg",
      product_description:
    ...
    },
    {
      id: 4,
      product_type: knex.raw("?::TEXT[]", [
        ["Heart Problems", "Fibromyalgia", "Muscle Recovery"],
      ]),
      product_title: "Potassium",
      img: "/assets/products/potassium.jpg",
      product_description:
    ...
    {
      id: 5,
      product_type: knex.raw("?::TEXT[]", [["Insomnia"]]),
    ...
    },
    {
      id: 6,
      product_type: knex.raw("?::TEXT[]", [
        ["Stress & Anxiety", "Inflammation & Joint Pain", "Low Libido"],
      ]),
      product_title: "Ashwagandha",
      img: "/assets/products/ashwagandha.jpg",
      product_description:
    ...
    },
    {
      ...
      img: "/assets/products/turmeric.jpg",
      product_description:
    ...
    },
    {
      id: 8,
      product_type: knex.raw("?::TEXT[]", [
        ["Liver Problems", "Gut Problems", "Low Energy"],
      ]),
      product_title: "Milk Thistle",
      img: "/assets/products/milk_thistle.jpg",
      product_description:
    ...
    },
    {
      id: 9,
      product_type: knex.raw("?::TEXT[]", [
        ["Gut Problems", "Inflammation & Joint Pain", "Overall Immunity"],
      ]),
    ...
    {
      id: 10,
      product_type: knex.raw("?::TEXT[]", [["Bacterial & Fungal Infections"]]),
      product_title: "Tea Tree Oil",
      img: "/assets/products/tea_tree_oil.jpg",
      product_description:
    ...
    {
      id: 11,
      product_type: knex.raw("?::TEXT[]", [["Low Energy", "Heart Problems"]]),
      product_title: "Vitamin B12",
      img: "/assets/products/vitamin_b12.jpg",
      product_description:
    ...
    {
      id: 12,
      product_type: knex.raw("?::TEXT[]", [["Insomnia", "Stress & Anxiety"]]),
      product_title: "Valerian Root",
      img: "/assets/products/valerian_root.jpg",
      product_description:
    ...
    },
    {
      ...
      img: "/assets/products/l_arginine.jpg",
      product_description:
    ...
    },
    {
      id: 14,
      product_type: knex.raw("?::TEXT[]", [
        ["Gut Problems", "Inflammation & Joint Pain"],
      ]),
      product_title: "Ginger",
      img: "/assets/products/ginger.jpg",
      product_description:
    ...
    },
    {
      id: 15,
      product_type: knex.raw("?::TEXT[]", [
        ["Low Energy", "Low Libido", "Overall Immunity", "Hormonal Imbalances"],
      ]),
      product_title: "DHEA",
      img: "/assets/products/dhea.jpg",
      product_description:
    ...
    },
    {
      id: 16,
      product_type: knex.raw("?::TEXT[]", [
        ["Inflammation & Joint Pain", "Stress & Anxiety", "Muscle Recovery"],
      ]),
    ...
    {
      id: 17,
      product_type: knex.raw("?::TEXT[]", [["Low Energy", "Muscle Recovery"]]),
      product_title: "Creatine",
      img: "/assets/products/creatine.jpg",
      product_description:
    ...
    },
    {
      id: 18,
      product_type: knex.raw("?::TEXT[]", [
        ["Low Energy", "Hormonal Imbalances", "Overall Immunity"],
      ]),
      product_title: "Selenium",
      img: "/assets/products/selenium.jpg",
      product_description:
    ...
    },
    {
      id: 19,
      product_type: knex.raw("?::TEXT[]", [
        ["Overall Immunity", "Inflammation & Joint Pain", "Liver Problems"],
      ]),
      product_title: "Glutathione",
      img: "/assets/products/glutathione.jpg",
      product_description:
    ...
    {
      id: 20,
      product_type: knex.raw("?::TEXT[]", [["Cold & Flu", "Overall Immunity"]]),
      product_title: "Zinc",
      img: "/assets/products/zinc.jpg",
      product_description:
    ...
    },
    {
      id: 21,
      product_type: knex.raw("?::TEXT[]", [
        ["Stress & Anxiety", "Muscle Recovery", "Fibromyalgia"],
      ]),
    ...
    },
    {
      id: 22,
      product_type: knex.raw("?::TEXT[]", [
        ["Heart Problems", "Overall Immunity"],
      ]),
      product_title: "Fish Oil",
      img: "/assets/products/fish_oil.jpg",
      product_description:
    ...
    {
      id: 23,
      product_type: knex.raw("?::TEXT[]", [["Low Energy", "Overall Immunity"]]),
      product_title: "Iron",
      img: "/assets/products/iron_pills.jpg",
      product_description:
    ...
    {
      id: 24,
      product_type: knex.raw("?::TEXT[]", [["Muscle Recovery"]]),
      product_title: "Whey Protein",
      img: "/assets/products/whey.jpg",
      product_description:
    ...
    },
    {
      ...
      img: "/assets/products/lavender_oil.jpg",
      product_description:
